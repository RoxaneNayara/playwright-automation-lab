...
test.describe('API · DummyJSON · Produtos · Robustez', () => {
  test(
    'criar produto com preço em texto deve retornar uma resposta controlada',
    {
      tag: [
        '@api',
        '@dummyJson',
    ...
    async ({ request }) => {
      ...
      await allure.story('Criação de produto com preço em texto');
